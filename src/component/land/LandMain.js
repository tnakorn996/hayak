    ...
    <div>
        <main className="">
            ...
            <section className="relative h-[35vh] md:h-[40vh] flex justify-center items-center  overflow-hidden ">
                ...
                <div className="h-full w-screen absolute bottom-0 left-0  bg-white bg-opacity-30" />
                <h1 className="text-3xl pt-[20px] px-[20px] md:px-[50px] absolute top-16 left-0  m-h6 font-serif first-letter:uppercase">{data?.breadmaintitle}</h1>
            </section>
            {/* <br />
            <br />
            <hr /> */}
