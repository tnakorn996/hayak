...
function ToastMain() {
  ...
  return (
    <div>
        <motion.main  initial={{opacity: 0}} animate={{opacity: 1}} exit={{opacity: 0}}  className="z-10 w-full fixed bottom-0 left-0 flex items-center  bg-black text-white duration-100">
