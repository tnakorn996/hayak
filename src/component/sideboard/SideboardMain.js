...
function SideboardMain() {
  ...
  return (
    <div>
        <motion.main initial={{x: -100}} animate={{ x:0}} exit={{x: -100}} className="h-screen w-[95vw] md:max-w-[55vw] fixed top-0 left-0 flex flex-col justify-start items-center bg-black text-white">
